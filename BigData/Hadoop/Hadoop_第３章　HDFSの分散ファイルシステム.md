...
step4/step5：図を参考として説明してきていま複数のDataNode節点アドレスを返却されてあり、分別がdn16、dn57、dn89三つの節点です。クライアントのFSDataOutputStreamが一つ目のdn16に信号を発送してアップロード操作があると知らせます。次にdn16節点がdn57節点に知らせ、次第に次の節点に同じな操作を行って最後のdn89節点が請求信号を受信したまでで、前の節点に返信することがあるんです。FSDataOutputStreamが順調にdn16節点の返信を受け取ると一つの完全な通信チャンネルを確立します。読み込み流れと全然違うでしょう。
